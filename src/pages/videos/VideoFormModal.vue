<template>
  <BaseFormModal
    ...
    @save="submitForm"
  >
    <form @submit.prevent="submitForm" novalidate :class="{ 'was-validated': wasValidated }" id="videoForm">
...
import { addVideo, updateVideo } from '@/services/general/website/videos/videos';
