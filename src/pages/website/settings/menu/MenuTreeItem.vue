<template>
  <div class="menu-item">
    <div class="menu-item-content">
      ...
      <i :class="item.icon || 'fa fa-link'" class="me-2 item-icon"></i>
      <span>{{ item.nama }}</span>
      <span v-if="item.nama_en" class="text-muted ms-2">({{ item.nama_en }})</span>
...
.menu-item-content > span:not(.text-muted):not(.badge) {
    font-weight: 600;
    color: #333;
}
