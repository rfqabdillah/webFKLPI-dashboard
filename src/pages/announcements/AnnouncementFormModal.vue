    ...
    >
      ...
      <div class="mb-3">
        ...
        <BaseRichTextEditor
          ...
          placeholder="Masukkan konten pengumuman (Bahasa)"
        />
        <div class="invalid-feedback">
          {{ formErrors.konten }}
        </div>
      ...
      <div class="mb-3">
        ...
        <BaseRichTextEditor
          ...
          placeholder="Masukkan konten pengumuman (English)"
        />
        <div class="invalid-feedback">
...
import {
  addAnnouncement,
  updateAnnouncement,
} from "@/services/general/website/announcements/announcements";
...
async function submitForm() {
  ...
  try {
    if (isEditMode.value) {
      const fieldId = props.fieldToEdit.idpengumuman;
      data.append("_method", "PUT");
      await updateAnnouncement(fieldId, data);
