        ...
        <div class="col-md-6">
          <div class="mb-3">
            ...
            >
              ...
              <option v-if="typesLoading" value="" disabled>
                Memuat kategori...
              </option>
              <option
                v-for="documentType in documentTypesList"
                :key="documentType.idjenisdokumen"
                :value="documentType.idjenisdokumen"
              >
...
} from "@/services/general/website/measurementBooks/measurementBooks";
...
const validationSchema = yup.object().shape({
  idjenisdokumen: yup.string().required("Jenis dokumen wajib dipilih."),
  tahun: yup
    .number()
...
async function handleDocumentUpload(event) {
  ...
  const resetToOriginal = () => {
    ...
    documentPreviewName.value = isEditMode.value
      ? getFilenameFromUrl(props.fieldToEdit.dokumen)
      : null;
    if (input) input.value = null;
  };
