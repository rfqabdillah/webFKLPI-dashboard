<template>
  <div class="skeleton-group">
    ...
    <template v-else-if="type === 'dashboard-greeting'">
      <div class="card profile-box skeleton-greeting">
        <div class="card-body">
          <div class="media">
    ...
    <template v-else-if="type === 'dashboard-stats'">
      <div class="row">
        <div v-for="n in 6" :key="n" class="col-xl-4 col-sm-6 mb-4">
          <div class="card widget-1" style="background-image: none">
            <div class="card-body">
              <div class="widget-content d-flex align-items-center gap-3">
                <BaseSkeleton
                  variant="custom"
                  width="54px"
                  height="54px"
    ...
    <!-- Dashboard Calendar Skeleton -->
    <template v-else-if="type === 'dashboard-calendar'">
      <div class="card">
        <div class="card-header pb-0">
          <BaseSkeleton variant="heading" width="150px" class="mb-3" />
          <div class="d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center gap-2">
              <BaseSkeleton variant="button" width="140px" height="32px" />
              <BaseSkeleton variant="text" width="50px" />
            </div>
        ...
        <div class="card-body">
          ...
          <hr class="mb-4" />
          <!-- Reminders -->
          <BaseSkeleton variant="heading" width="100px" class="mb-3" />
          <div
            v-for="n in 3"
            :key="'r' + n"
    ...
    <!-- Dashboard Users Online Skeleton -->
    <template v-else-if="type === 'dashboard-users'">
      <div class="card">
        <div class="card-header pb-0 card-no-border">
          <BaseSkeleton variant="heading" width="200px" />
        </div>
        <div class="card-body pt-0">
          ...
          >
            <BaseSkeleton variant="avatar" class="me-3" />
            <div class="flex-grow-1">
              <BaseSkeleton variant="text" width="120px" class="mb-1" />
              <BaseSkeleton variant="text" width="80px" height="12px" />
            </div>
            <BaseSkeleton variant="badge" width="60px" height="24px" />
          </div>
        </div>
      </div>
    </template>
    ...
    <template v-else-if="type === 'dashboard-chart'">
      <div class="card">
        <div class="card-header pb-0 card-no-border">
          <div class="d-flex justify-content-between align-items-start">
            <div>
